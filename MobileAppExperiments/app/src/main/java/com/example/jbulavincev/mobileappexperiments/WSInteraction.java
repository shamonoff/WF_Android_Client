 ...
 */
class RetrieveArrayTask extends AsyncTask<Void, Void, String> {
    ...
    public RetrieveArrayTask (Context context){
        mContext = context;
    }
          ...
          //  httpget.addHeader("Authorization", "Basic "+ Base64.encodeToString((USER_NAME+":"+PASSWORD).getBytes(),android.util.Base64.NO_WRAP));
            ...
            if (entity != null) {
              ...
              //  if (Response.substring(0, 9) == "<!DOCTYPE") throw new Exception() ;
                if (Response.substring(2, 9).compareToIgnoreCase("doctype") == 0) Response = "HTML ERROR" ;
    ...
    protected void onPostExecute(String s) {
        Log.d("WSInteraction", "onPostExecute");
